...
void client::envoyerSMS(const QString &destinataire, const QString &message)
{
...
void client::on_SMS_clicked()
{
    QString destinataire = "+21629347440"; // ekte2b9 num li amlna bih l compte
